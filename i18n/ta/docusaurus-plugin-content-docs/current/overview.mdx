...
சேவா தளம் விற்பனையாளர் மினி ஆப்ஸ்களை சேவா குடிமகன் ஷெல் (web மற்றும் Flutter) உள்ளே ஹோஸ்ட் செய்கிறது. ஹோஸ்ட் ஒவ்வொரு மினி ஆப்பையும் ES தொகுதியாக ஏற்றுகிறது, SDK ஐ `window.__SEWA_SDK__` இல் செலுத்துகிறது, மற்றும் அனைத்து சலுகை பெற்ற செயல்பாடுகளையும் RPC பாலம் மூலம் மத்தியஸ்தம் செய்கிறது.

## இயக்க மாதிரி

- **மினி ஆப் தொகுப்பு**: Vite `lib` கட்டமைப்பு `mount(container, runtime)` ஏற்றுமதி செய்கிறது - [`தொடங்குதல்`](/docs/getting-started) மற்றும் [`test-mini-app/`](https://github.com/<repo>/sewa-platform/tree/main/test-mini-app) பார்க்கவும்.
- **SDK செலுத்துதல்**: ஹோஸ்ட் `mount` ஐ அழைப்பதற்கு முன் `window.__SEWA_SDK__` ஐ அமைக்கிறது. SDK இன் `npm install` தேவையில்லை.
...
sequenceDiagram
    ...
    participant SDK as window.__SEWA_SDK__
    Host->>MiniApp: mount(container, { initialPath })
    MiniApp->>SDK: window.__SEWA_SDK__
