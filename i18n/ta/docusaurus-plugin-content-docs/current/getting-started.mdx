...
சேவா மினி ஆப் SDK ஹோஸ்ட் ஷெல் மூலம் இயக்க நேரத்தில் `window.__SEWA_SDK__` வழியாக **செலுத்தப்படுகிறது**. நீங்கள் SDK ஐ `npm install` செய்ய வேண்டாம். அதற்கு பதிலாக, உங்கள் மினி ஆப் மேம்பாட்டிற்காக பகிரப்பட்ட வகை தொகுப்பை சார்ந்துள்ளது, மற்றும் ஹோஸ்ட் உங்கள் ஆப் கொள்கலனுக்குள் ஏற்றப்படும் போது நேரடி SDK நிகழ்வை வழங்குகிறது.
...
```mermaid
flowchart LR
    A["வகை தொகுப்பு<br/>(devDependency)"] -->|"import type MiniAppSdkInterface"| B["gov-sdk.d.ts<br/>declare global Window.__SEWA_SDK__"]
    B --> C["உங்கள் குறியீடு<br/>sdk.auth.getUser() — முழுமையாக வகைப்படுத்தப்பட்டது"]
    D["ஹோஸ்ட் ஷெல்<br/>(CDN / native bridge)"] -->|"இயக்க நேரத்தில் செலுத்தப்பட்டது"| E["window.__SEWA_SDK__"]
    E --> C
```
...
## 1. வகை அறிவிப்புகள் (`gov-sdk.d.ts`)

ஹோஸ்ட் செலுத்தும் உலகளாவியவற்றை TypeScript அறியும் வகையில் அறிவிக்கவும். இது [`test-mini-app/src/gov-sdk.d.ts`](/ta/docs/getting-started) இலிருந்து கோப்பு:
