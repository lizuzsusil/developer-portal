...
export function FinalCTA() {
  return (
    <section className="relative overflow-hidden border-t border-[var(--color-border-decorative)] bg-[var(--color-surface-masthead)] pt-12 pb-14">
      <div
        aria-hidden
        className="pointer-events-none absolute top-0 left-1/2 h-[800px] w-[800px] -translate-x-1/2 rounded-full bg-[radial-gradient(circle,rgba(255,199,0,0.04)_0%,transparent_60%)]"
      />
      <div className="container relative z-[1] text-center">
        ...
        <p className="mx-auto mt-0 mb-7 max-w-[580px] text-[0.98rem] leading-[1.65] text-[#9aa0b0]">
